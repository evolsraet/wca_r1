<div>
    <div class="auction-price-box border-top pt-4" x-data="auctionDealerIng" x-show="!auction?.bids[0]?.id">
        ...
        <div class="text-center text-danger fw-semibold mb-2">
            현재 <span class="text-dark" x-text="auction?.bids_count"></span>명이 입찰했어요.
        </div>
