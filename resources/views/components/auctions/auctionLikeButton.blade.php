        ...
        <div>
            <button
                ...
                @click="window.dispatchEvent(new CustomEvent('toggle-like', {
                    ...
                    likeId: auction?.likes?.find(like => like.user_id === window.userId)?.id || null
                    }
                }))"
            ...
            >
            <i class="mdi mdi-heart border-1" :class="auction?.likes?.find(like => like.user_id === window.userId)?.id ? 'text-danger' : 'text-white'"></i>
            </button>
        </div>
    </div>
</div>
