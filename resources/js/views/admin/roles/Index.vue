                                ...
                                <tr v-for="post in roles.data" :key="post.id">
                                    ...
                                    <td class="px-6 py-4 text-sm">
                                        ...
                                        <a
                                            href="#"
                                            v-if="can('role.admin')"
                                            @click.prevent="deleteRole(post.id)"
...
watch(search_id, (current, previous) => {
    getRoles(1, current, search_title.value, search_global.value);
});
watch(search_title, (current, previous) => {
    getRoles(1, search_id.value, current, search_global.value);
});
watch(
    search_global,
    _.debounce((current, previous) => {
        getRoles(1, search_id.value, search_title.value, current);
    }, 200)
);
</script>
