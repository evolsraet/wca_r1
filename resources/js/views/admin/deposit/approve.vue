            ...
            <div class="mb-4">
              <div>
                <div class="d-flex align-items-baseline justify-content-between">
                  <h4>No.3801<span class="text-muted ms-3 fw-lighter">차량번호 {{auction.car_no}}</span></h4>
