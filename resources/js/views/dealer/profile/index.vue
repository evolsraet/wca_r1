        ...
        <div class="regiest-content">
                ...
                <div class="styled-div mt-0">
                    ...
                    <div class="activity-info bold-18-font mt-5">
                        ...
                        <div class="item">
                            ...
                            <p class="interest-icon text-muted normal-16-font">관심</p>
                        </div>
                        <div class="item">
                            <p><span class="tc-red">{{ bidsCountByUser[user.dealer.user_id] || 0 }}</span> 건</p>
                            <p class="bid-icon text-muted normal-16-font">입찰</p>
                        </div>
                        <div class="item">
                            <p><span class="tc-red">{{ filteredViewBids.length }}</span> 건</p>
                            <p class="suc-bid-icon text-muted normal-16-font">낙찰</p>
                        </div>
                        -->
                     <!--   <div class="item">
                            <p><span class="tc-red">{{ bidsCountByUser[user.dealer.user_id] || 0 }}</span> 건</p>
                            <p class="purchase-icon text-muted normal-16-font">매입</p>
                        </div>-->
                    </div>
                </div>
            </div>
            ...
            <div v-if="currentTab === 'dealerInfo'">
                ...
                <div class="intro mt-3">
                    <h5 class="text-muted mb-3">소개</h5>
            ...
            <div class="p-3" v-if="currentTab === 'pastAuctions'">
                ...
                <span class="text-muted">딜러가 낙찰받은 매물들이에요.</span>
                <!--
                        ...
                        <div v-if="!isData" class="complete-car">
                            <div class="card my-auction mt-3">
                                <div class="none-complete">
                                    <span class="text-muted">낙찰 받은 매물이 없습니다.</span>
                                </div>
                            </div>
                        </div>
                        <nav>
