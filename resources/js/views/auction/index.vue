<template>
    ...
    <div class="container my-3">
        <div class="row mt-5">
            <!-- 사이드바 -->
            <div class="sider-content col-md-3">
                ...
                <div class="container mt-5">
                    <table class="table custom-border">
                        <tbody class="auction-table">
                            <tr>
                                <td class="auction_no tc-light-gray">경매번호<span></span>202307200006</td>
...
<style>
    .auction-table .car_name {
        width: 42%;
    }
    .auction-table .part_whether{
        width: 9%;
    }
    .auction-table .time-remain {
        width: 10%; 
    }
    .auction-table .auc-state{
        width: 10%;
    }
