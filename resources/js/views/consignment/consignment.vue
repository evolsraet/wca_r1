<template>
      ...
      <div v-if="!fileuploadvue" class="card p-3 my-4">
        <div class="profile ms-0 p-0">
          <div class="dealer-info">
            ...
            <div class="deal-info">
              ...
              <h4>3,200만원</h4>
              <p><span class="fw-medium">홍길동</span>딜러</p>
        ...
        <div>
          ...
          <div class="d-flex justify-content-between">
            <h5>{{ monthLabel }}</h5>
            <p class="tc-light-gray">익일 9시 이후부터 탁송이 가능해요.</p>
          </div>
          <div class="date-time-picker">
            <div class="date-picker">
              <div
                ...
                :key="index"
                class="date-container d"
              >
                <div class="day-label">{{ day.label }}</div>
                <div
                  :class="['date', { selected: selectedDay === index }]"
            ...
            <div class="my-3 time-picker" v-if="selectedDay !== null">
              ...
              <div class="time-section">
                <div
                  ...
                  :key="time"
                  :class="['time', { selected: selectedTime === time, disabled: isPastTime(time) }]"
        ...
        <button type="button" class="btn btn-primary" @click="toggleView">다음</button>
      </div>
      <div v-if="fileuploadvue" class="card p-3 my-4">
    ...
    <button class="btn btn-primary my-3" @click="navigateToCompletionSuccess">완료</button>
    </div>
    </div>
  </template>
  ...
  const navigateToCompletionSuccess = () => {
