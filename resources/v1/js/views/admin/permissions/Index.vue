                ...
                <div class="card-body shadow-sm">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr
                                    v-for="post in permissions.data"
                                    :key="post.id"
                                >
...
watch(search_id, (current, previous) => {
    getPermissions(1, current, search_title.value, search_global.value);
});
watch(search_title, (current, previous) => {
    getPermissions(1, search_id.value, current, search_global.value);
});
watch(
    search_global,
    _.debounce((current, previous) => {
        getPermissions(1, search_id.value, search_title.value, current);
    }, 200)
);
</script>
