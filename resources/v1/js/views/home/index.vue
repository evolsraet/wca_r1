    ...
    <div class="main-contenter">
        ...
        <div class="web-style-overlay web-stlye">
          ...
          <div class="web-style-overlay02" v-if="!user?.name">
            ...
            <h5 class="size_18 tc-wh">저는 딜러에요! <a href="/v1/register?type=dealer" class="ms-3 tc-wh underline">딜러회원가입</a></h5>
          </div>
        </div>
        <div class=" web-stlye">
        <!-- Swiper 섹션 -->
      ...
      <div class="tc-wh mobile-css" v-if="!user?.name">
        ...
        <p class="size_18 ps-2">저는 딜러에요! <a href="/v1/register?type=dealer" class="ms-3 tc-wh underline">딜러회원가입</a></p>
      </div>
    </div>
    </div>
  </div>
              ...
              <div class="row mt-4">
                ...
                <div class="col-12 d-flex flex-column mt-4 sticky-bottom">
                  ...
                  <div class="d-flex justify-content-end my-2 flex-column" v-if="!user?.name">
                    <router-link :to="{ path: '/v1/login' }" class="btn btn-outline-primary tc-primary">로그인</router-link>
                  </div>
                </div>
