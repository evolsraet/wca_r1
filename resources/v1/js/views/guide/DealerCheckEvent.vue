<template>
    <div class="form-group dealer-check" v-if="props.mode === 'check1'">
    ...
    <a @click.prevent="isDealerCheckEvent" class="icon-link" v-if="props.mode === 'check2'">
...
<script setup>
   ...
   const isDealerCheckEvent = () => {
    ...
    const text = `<div style="height: 500px; overflow-y: scroll; text-align: left;" class="info-popup">
