                            ...
                            <div class="content d-flex">
                                <div>
                                    ...
                                    <!-- <router-link
                                        ...
                                        :to="{ path: '/' }"
                                        > -->
                                    <a class="btn-sell-car d-flex bc-primary border-none mt-5"href="/v1/carfind-do">
                                    <div>
                            ...
                            <div class="content d-flex text-start">
                                <div>
                                    ...
                                    <!-- <router-link
                                        ...
                                        :to="{ path: '/' }"
                                        > -->
                                    <a class="btn-sell-car d-flex bc-primary border-none"href="/v1/carfind-do">
                                    <div>
                                        <span class="icon-car me-1"><img src="../../../img/icon-small-car.png" width="20"></span><span class="size_14">내 차 판매하기</span> 
                                    </div>
                                    <img src="../../../img/Icon-right-wh.png" class="dash-wh" width="10">
                        ...
                        <div class="card-body">
                            <div class="none-complete flex-column">
                                <div class="text-secondary opacity-50 d-flex align-items-center gap-3 my-3">
                                    <router-link to="/v1/"  class="px-5 btn btn-outline-secondary btn-lg bc-wh">
                                        이용후기 등록 하기
                                    </router-link>
                                </div>
