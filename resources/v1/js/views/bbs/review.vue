        ...
        <div class="main-contenter">
            <div class="review">
                <div class="review-content mov-review my-5" v-if="loading">
                    ...
                    <router-link to="/v1/alllist-do" class="anymation mt-5 btn shadow-sm border w-100 hp-50 d-flex align-items-center justify-content-center gap-2">다른 분들의 이용후기도 둘러보세요!<span class="black-right-icon"></span></router-link>
                </div>
            </div>
        </div>
    </div>
