...
namespace Illuminate\Support\Facades {
     ...
     */        class Request {
         ...
         * @param mixed $allData
         * @static 
         */        public static function dbFilter($modelPrefix, $allData)
        {
                        return \Illuminate\Http\Request::dbFilter($modelPrefix, $allData);
        }
            }
            /**
     * 
     ...
     */        class Response {
         ...
         * @static 
         */        public static function api($data = null, $message = null, $status = 'ok', $code = 200, $additional = [])
        {
                        return \Illuminate\Routing\ResponseFactory::api($data, $message, $status, $code, $additional);
        }
            }
            /**
     * 
